...
namespace Compil
{
    public static class Compil
    {
        public static void ExecuteCompil(string pathSln, string pathLog)
        {
            ...
            string logFilePath = pathLog;//assemblyExecutionPath.Remove(assemblyExecutionPath.LastIndexOf("\\") + 1) + "build.log";
            List<string> OutputHeaderRow = new List<string>();
            List<string> OutputItemRow = new List<string>();
            string artifactPath = pathSln;//@"C:\Users\Quentin\Documents\Visual Studio 2013\Projects\AQGPI\AQGPI.sln";
